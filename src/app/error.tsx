...
export default function GlobalError({ reset }: ErrorPageProps) {
  return(
    <main className="flex flex-col justify-center items-center">
      ...
      <button onClick={reset} className="block w-fit font-bold py-2 px-4 rounded-lg  text-transparent bg-gradient-to-r from-purple-500 to-pink-500 text-xl cursor-pointer text-white mt-5">Volver a intentar</button>
    </main>
  )
}